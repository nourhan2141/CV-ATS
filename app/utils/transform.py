...
from app.core.models import JSONResume
...
CSV_FIELD_NAMES = [
    ...
    "github_created_at",
    "github_bio",
    "parseability_formatting_score",
    "parseability_formatting_max",
    "section_structure_score",
    "section_structure_max",
    "content_quality_score",
    "content_quality_max",
    "keyword_optimization_score",
    "keyword_optimization_max",
    "total_score",
    "total_max",
    "deductions",
    "deduction_reasons",
    "has_multi_column_layout",
    "has_tables",
    "has_text_in_images",
    "is_scanned_pdf",
    "missing_sections",
    "contact_info_in_header_footer",
    "font_count",
    "page_count",
    "word_count",
    "key_strengths",
...
def transform_evaluation_response(
    ...
    """
    csv_row = {field: "" for field in CSV_FIELD_NAMES}
    ...
    if evaluation and hasattr(evaluation, "scores"):
        ...
        csv_row["parseability_formatting_score"] = scores.parseability_formatting.score
        csv_row["parseability_formatting_max"] = scores.parseability_formatting.max

        csv_row["section_structure_score"] = scores.section_structure.score
        csv_row["section_structure_max"] = scores.section_structure.max

        csv_row["content_quality_score"] = scores.content_quality.score
        csv_row["content_quality_max"] = scores.content_quality.max

        csv_row["keyword_optimization_score"] = scores.keyword_optimization.score
        csv_row["keyword_optimization_max"] = scores.keyword_optimization.max

        total_score = (
            scores.parseability_formatting.score
            + scores.section_structure.score
            + scores.content_quality.score
            + scores.keyword_optimization.score
        )
        total_max = (
            scores.parseability_formatting.max
            + scores.section_structure.max
            + scores.content_quality.max
            + scores.keyword_optimization.max
        )

        csv_row["total_score"] = total_score
        csv_row["total_max"] = total_max
    else:
        csv_row["parseability_formatting_score"] = "N/A"
        csv_row["parseability_formatting_max"] = "N/A"
        csv_row["section_structure_score"] = "N/A"
        csv_row["section_structure_max"] = "N/A"
        csv_row["content_quality_score"] = "N/A"
        csv_row["content_quality_max"] = "N/A"
        csv_row["keyword_optimization_score"] = "N/A"
        csv_row["keyword_optimization_max"] = "N/A"
    ...
    # Extract ATS report
    if evaluation and hasattr(evaluation, "ats_report") and evaluation.ats_report:
        csv_row["has_multi_column_layout"] = evaluation.ats_report.has_multi_column_layout
        csv_row["has_tables"] = evaluation.ats_report.has_tables
        csv_row["has_text_in_images"] = evaluation.ats_report.has_text_in_images
        csv_row["is_scanned_pdf"] = evaluation.ats_report.is_scanned_pdf
        csv_row["missing_sections"] = "; ".join(evaluation.ats_report.missing_sections) if evaluation.ats_report.missing_sections else ""
        csv_row["contact_info_in_header_footer"] = evaluation.ats_report.contact_info_in_header_footer
        csv_row["font_count"] = evaluation.ats_report.font_count
        csv_row["page_count"] = evaluation.ats_report.page_count
        csv_row["word_count"] = evaluation.ats_report.word_count
    else:
        csv_row["has_multi_column_layout"] = ""
        csv_row["has_tables"] = ""
        csv_row["has_text_in_images"] = ""
        csv_row["is_scanned_pdf"] = ""
        csv_row["missing_sections"] = ""
        csv_row["contact_info_in_header_footer"] = ""
        csv_row["font_count"] = ""
        csv_row["page_count"] = ""
        csv_row["word_count"] = ""
